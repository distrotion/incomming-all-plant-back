...
let mongodb = require('../../function/mongodbBP12PAL');
...
router.post('/04BP12PAL/getmaster', async (req, res) => {
  //-------------------------------------
  console.log("----04BP12PAL/getmaster----");
...
router.post('/04BP12PAL/GETdata', async (req, res) => {
  //-------------------------------------
  console.log("----04BP12PAL/GETdata----");
  console.log(req.body);
  let input = req.body;
...
router.post('/04BP12PAL/SETgood', async (req, res) => {
  //-------------------------------------
  console.log("----04BP12PAL/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/04BP12PAL/SETgoodandDATA', async (req, res) => {
  //-------------------------------------
  console.log("----04BP12PAL/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/04BP12PAL/test', async (req, res) => {
  //-------------------------------------
  console.log("----04BP12PAL/test----");
  console.log(req.body);
  let input = req.body;
