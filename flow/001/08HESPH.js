...
let mongodb = require('../../function/mongodbHESPH');
...
router.post('/07HESPH/getmaster', async (req, res) => {
  //-------------------------------------
  console.log("----07HESPH/getmaster----");
...
router.post('/07HESPH/GETdata', async (req, res) => {
  //-------------------------------------
  console.log("----07HESPH/GETdata----");
  console.log(req.body);
  let input = req.body;
...
router.post('/07HESPH/SETgood', async (req, res) => {
  //-------------------------------------
  console.log("----07HESPH/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/07HESPH/test', async (req, res) => {
  //-------------------------------------
  console.log("----07HESPH/test----");
  console.log(req.body);
  let input = req.body;
