...
// router.post('/08HESPH/getmaster', async (req, res) => {
//   //-------------------------------------
//   console.log("----08HESPH/getmaster----");
...
// router.post('/08HESPH/GETdata', async (req, res) => {
//   //-------------------------------------
//   console.log("----08HESPH/GETdata----");
//   console.log(req.body);
//   let input = req.body;
...
// router.post('/08HESPH/SETgood', async (req, res) => {
//   //-------------------------------------
//   console.log("----08HESPH/SETgood----");
//   console.log(req.body);
//   let input = req.body;
...
// router.post('/08HESPH/test', async (req, res) => {
//   //-------------------------------------
//   console.log("----08HESPH/test----");
//   console.log(req.body);
//   let input = req.body;
