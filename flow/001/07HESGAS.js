...
let mongodb = require('../../function/mongodbHESGAS');
...
router.post('/07HESGAS/getmaster', async (req, res) => {
  //-------------------------------------
  console.log("----07HESGAS/getmaster----");
...
router.post('/07HESGAS/GETdata', async (req, res) => {
  //-------------------------------------
  console.log("----07HESGAS/GETdata----");
  console.log(req.body);
  let input = req.body;
...
router.post('/07HESGAS/SETgood', async (req, res) => {
  //-------------------------------------
  console.log("----07HESGAS/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/07HESGAS/test', async (req, res) => {
  //-------------------------------------
  console.log("----07HESGAS/test----");
  console.log(req.body);
  let input = req.body;
