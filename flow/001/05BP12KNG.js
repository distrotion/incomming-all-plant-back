...
let mongodb = require('../../function/mongodbBP12KNG');
...
router.post('/05BP12KNG/getmaster', async (req, res) => {
  //-------------------------------------
  console.log("----05BP12KNG/getmaster----");
...
router.post('/05BP12KNG/GETdata', async (req, res) => {
  //-------------------------------------
  console.log("----05BP12KNG/GETdata----");
  console.log(req.body);
  let input = req.body;
...
router.post('/05BP12KNG/SETgood', async (req, res) => {
  //-------------------------------------
  console.log("----05BP12KNG/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/05BP12KNG/SETgoodandDATA', async (req, res) => {
  //-------------------------------------
  console.log("----05BP12KNG/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/05BP12KNG/test', async (req, res) => {
  //-------------------------------------
  console.log("----05BP12KNG/test----");
  console.log(req.body);
  let input = req.body;
