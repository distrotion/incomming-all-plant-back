...
let mongodb = require('../../function/mongodbHESPAL');
...
router.post('/10HESPAL/getmaster', async (req, res) => {
  //-------------------------------------
  console.log("----10HESPAL/getmaster----");
...
router.post('/10HESPAL/GETdata', async (req, res) => {
  //-------------------------------------
  console.log("----10HESPAL/GETdata----");
  console.log(req.body);
  let input = req.body;
...
router.post('/10HESPAL/SETgood', async (req, res) => {
  //-------------------------------------
  console.log("----10HESPAL/SETgood----");
  console.log(req.body);
  let input = req.body;
...
router.post('/10HESPAL/test', async (req, res) => {
  //-------------------------------------
  console.log("----10HESPAL/test----");
  console.log(req.body);
  let input = req.body;
